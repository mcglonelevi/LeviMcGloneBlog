...
I've also seen humans make these same mistakes over my career. I have seen entire libraries imported just to be used one or two times or for some obscure util function. I have also seen the same code copy-pasted in several places for no good reason. I did not approve those PRs back then, and I won't approve them now -- even if a computer generated them.
